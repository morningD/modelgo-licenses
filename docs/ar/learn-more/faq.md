...
تنطبق تراخيص MG فقط على النموذج، لكن بنودها تحكم <mark style="color:purple;">استخدام وتوزيع النموذج ومشتقاته، وكذلك مخرجاته، والشيفرة والسكربتات المكملة</mark>. نصنف هذه الكائنات إلى أربع فئات لتحديد نطاق الشروط: المواد المرخصة (Licensed Materials)، والمواد المشتقة (Derivative Materials)، والنماذج المستخرجة (Extracted Models)، والمخرجات (Output)، ولكل منها شروط تقييد وسياسات استخدام مختلفة. النماذج المستخرجة هي نماذج تم إنشاؤها عن طريق نقل الأنماط من مخرجات النموذج، مثل طرق التقطير. على سبيل المثال، وفقًا لشروط MG-BY-ND-2.0، يُسمح بمشاركة نسخة حرفية من المواد المرخصة بينما يُحظر مشاركة أي مواد مشتقة أو نماذج مستخرجة.
...
<mark style="color:purple;">**حاليًا، لا.**</mark> لم تتم الموافقة على أي من متغيرات تراخيص ModelGo من قبل مبادرة المصدر المفتوح (OSI) بعد. ومع ذلك، نهدف إلى أن يحافظ MG-BY-SA-2.0 على "انفتاح" النموذج. ومن الجدير بالذكر أيضًا أن معنى "مفتوح" قد يختلف بين البرمجيات والنماذج. في تراخيص ModelGo، يعني SA توفر **المواد المرخصة** و**المواد المشتقة** و**النماذج المستخرجة**، باستثناء انفتاح مجموعة البيانات (حيث نعتبرها خارج نطاق حوكمة تراخيص MG).

## هل يمكنني إغلاق مصدر نماذجي المرخصة بموجب MG مع SA؟

<mark style="color:purple;">**لا.**</mark> ينطبق هذا على مشتقاتها والنماذج المستخرجة أيضًا. MG-BY-SA-2.0 هو ترخيص حقوق نسخ متروكة، مما يعني أن جميع الأعمال المشتقة والنماذج المستخرجة يجب أن تكون مشمولة بنفس الترخيص أيضًا. كما لا يمكنك إلغاء MG-BY-SA-2.0، على عكس GPL-3.0، الذي لا ينص صراحة على أن ترخيص براءة الاختراع الممنوح غير قابل للإلغاء.
