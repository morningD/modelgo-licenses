...
MG 라이선스는 모델에만 적용되지만, 그 조항은 <mark style="color:purple;">모델 및 그 파생물, 출력, 그리고 보완 코드 및 스크립트의 사용과 배포</mark>를 규율합니다. 이러한 객체를 라이선스 대상물, 파생 대상물, 출력의 세 가지 범주로 분류하여 조항의 범위를 정의하며, 각각 다른 제한 조항과 사용 정책을 가집니다. 예를 들어, MG-BY-ND-2.0의 조항에 따르면, 라이선스 대상물의 원본 그대로의 복사본 공유는 허용되지만 모든 파생 대상물의 공유는 금지됩니다.
...
<figure><img src="/images/scope.jpg" alt="MG 관할 범위"><figcaption><p>MG 관할 범위</p></figcaption></figure>
...
<figure><img src="/images/compati.jpg" alt="MG 호환성 표"><figcaption><p>MG 호환성 표</p></figcaption></figure>
