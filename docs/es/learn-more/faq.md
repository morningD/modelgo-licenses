...
Las licencias MG solo se aplican al Modelo, pero sus terminos rigen el <mark style="color:purple;">uso y distribucion del Modelo y sus derivados, asi como las salidas de estos, y el codigo y scripts complementarios</mark>. Clasificamos estos objetos en tres categorias para definir el alcance de los terminos: Licensed Materials, Derivative Materials y Output, cada uno con diferentes terminos de restriccion y politicas de uso. Por ejemplo, segun los terminos de MG-BY-ND-2.0, se permite compartir la copia literal de los Licensed Materials mientras que se prohibe compartir cualquier Derivative Materials.
